...
voronoi3d=function(Boxlim, resolution, perturb, Ncells, N,
                   percClutter=0.05, percWall=0.8, percFil=0.1, percClust=0.05){
...
if (Nclutter>0){
	clutterPoints=cbind(runif(Nclutter, Xlim[1], Xlim[2]),
