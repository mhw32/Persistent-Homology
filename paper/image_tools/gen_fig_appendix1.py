...
plt.tight_layout()
plt.savefig('figure_8_all_euler_group.pdf')
# plt.show()
...
plt.tick_params(axis='both', which='major', labelsize=25)    
plt.tight_layout()
plt.savefig('figure_8_all_silhouette_group.pdf')
# plt.show()
...
plt.tick_params(axis='both', which='major', labelsize=25)    
plt.tight_layout()
plt.savefig('figure_8_all_contour_group.pdf')
# plt.show()
...
plt.tick_params(axis='both', which='major', labelsize=25)
plt.tight_layout()
plt.savefig('figure_8_all_correlation_group.pdf')
# plt.show()
...
plt.tick_params(axis='both', which='major', labelsize=25)    
plt.tight_layout()
plt.savefig('figure_8_all_weighted_contour_group.pdf')
# plt.show()
