...
\begin{figure}[htp!]
  ...
  \begin{subfigure}{0.48\textwidth}
    ...
    \label{fig:valid2}
  \end{subfigure} \\
  \caption{A comparison of EC and CORR between the cube with the highest bottleneck distance (High) and the cube with the lowest (Low). (a) and (b) clearly depict larger differences between CDM (High) and WDM (High) slices than between CDM (Low) and WDM (Low).}
